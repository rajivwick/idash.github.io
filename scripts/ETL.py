...
def Load_meat_master_df(meat_master_df,filename):
...
def CreateDB(dbname,master_df,meat_master_df):
        ...
        # Create meat historical prices table
        ...
        # Store and commit meat historical data into the relevant table created
